...
const Storefront = () => {
  ...
  return (
    // Márgenes negativos (-m-4 sm:-m-8) para cancelar el padding del <main> del Layout
    // y que la tienda ocupe TODO el ancho (hero a sangre completa, sin borde blanco lateral).
