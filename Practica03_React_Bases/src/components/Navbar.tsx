...
// Ejercicio de Extensión: el Navbar controla el estado del Sidebar colapsable.
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-8">
      <div className="flex items-center gap-2 sm:gap-4">
        {/* Botón Toggle del ejercicio de extensión */}
        <button
          onClick={onToggleSidebar}
          className="p-2 hover:bg-slate-100 rounded-full transition text-slate-600 md:hidden"
